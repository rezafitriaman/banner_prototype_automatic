...
function adds(development) {
    ...
    devDynamicContent.export[2].PromotionImageLastFrame50procent.Url = "https://s0.2mdn.net/dynamic/2/10218806/productimages.bgenius.com/data/17c9135c37e2c158853c3795cdda402e/268910599950.png_1536476545051_268910599950.png";
    ...
    devDynamicContent.export[2].PromotionImageLastFrameInslaan.Url = "https://s0.2mdn.net/dynamic/2/10218806/productimages.bgenius.com/data/17c9135c37e2c158853c3795cdda402e/268910599950.png_1536476545051_268910599950.png";
    ...
    devDynamicContent.export[2].PromotionImageLastFrameEurootje.Url = "https://s0.2mdn.net/dynamic/2/10218806/productimages.bgenius.com/data/17c9135c37e2c158853c3795cdda402e/268910599950.png_1536476545051_268910599950.png";
...
function setupDom() {
  ...
  creative.dom.mainTxt3 = document.querySelector('#main-txt3');
...
function startAds(prefix) {
  ...
  if(prefix.export[0].PromotionType_eurootje_50procent_inslaan == "50procent") {
    ...
    setMainTxt(prefix.export[0].PromotionText_50procent, prefix);
    ...
    setMainTxt(prefix.export[0].PromotionText_Inslaan, prefix);
    ...
    setMainTxt(prefix.export[0].PromotionText_Eurootje, prefix);
  ...
  //function to set Internet Explorer specific styles
  // function IEStyles() {
  //   var isIE = /Trident/.test(navigator.userAgent) || /MSIE/.test(navigator.userAgent);
  //   if(isIE) {
  //     creative.dom.footerBestel.style.width = '119px';
  //   }
  // }

  //function to devide text in two strings if it contains more than 7 words
  function setMainTxt(str, prefix) {
    if(prefix.export[0].PromotionType_eurootje_50procent_inslaan == 'eurootje' && !(creative.dom.banner.offsetWidth == 120 || creative.dom.banner.offsetHeight == 160)) {
      if(str.trim().split(/\s+/).length > 2) {
        var strAr = str.split(' ');
        var strAr1 = strAr.splice(0, 2);
        var strAr2 = strAr.splice(0, 2);
        var strAr3 = strAr.splice(0, strAr.length);

        creative.dom.mainTxt1.innerHTML = strAr1.join(' ');
        creative.dom.mainTxt2.innerHTML = strAr2.join(' ');
        creative.dom.mainTxt3.innerHTML = strAr3.join(' ');
      } else {
        creative.dom.mainTxt1.innerHTML = str;
      }
    } else {
      if(str.trim().split(/\s+/).length > 3 && !(creative.dom.banner.offsetWidth == 120 || creative.dom.banner.offsetWidth == 160)) {
        var strAr = str.split(' ');
        var strAr1 = strAr.splice(0, 3);
  ...
  function setEndTxt(str) {
    if(creative.dom.banner.offsetWidth == 160) {
      if(str.trim().split(/\s+/).length > 2) {
        var strAr = str.split(' ');
        var strAr1 = strAr.splice(0, 2);
        var strAr2 = strAr.splice(0, strAr.length);
...
function animation() {
  ...
  //pause and play functionality for develop purposes
  ...
  /* if(creative.dom.banner.offsetWidth == 160 || creative.dom.banner.offsetWidth == 120){
     tl.to(creative.dom.mainImgSection, .1, {height: '21%', width: '100%'});
   } else {
     tl.to(creative.dom.mainImgSection, .1, {height: '32%', width: '100%'});
   }
   tl.to(creative.dom.mainImgSection, .2, {width: '83%'})
   .to(creative.dom.mainImgSection, .2, {width: '98%'})
   .to(creative.dom.mainImgSection, .2, {width: '88%'})
   .to(creative.dom.mainImgSection, .2, {width: '93%'})
   .to(creative.dom.mainImgSection, .2, {width: '91%'})
   .to(creative.dom.mainImgSection, .2, {width: '93%'});

   if(creative.dom.banner.offsetWidth == 160 || creative.dom.banner.offsetWidth == 120){
     tl.to(creative.dom.mainImgSection, .2, {css: {height: '21%', width: '93%'}, delay:1.0})
     .fromTo(creative.dom.mainTxt1, .2, {display:'block', top: '400px', position: 'relative', fontSize: '18pt'}, {top: '0px'});
   } else {
     tl.to(creative.dom.mainImgSection, .2, {css: {height: '32%', width: '83%'}, delay:1.0})
     .to(creative.dom.mainTxt1, .2, {fontSize: '18pt', display: 'block'})
     .to(creative.dom.mainTxt2, .2, {fontSize: '18pt', display: 'block'})
     .to(creative.dom.mainTxt3, .2, {fontSize: '18pt', display: 'block'});
   }*/
   tl
   .to(creative.dom.startScreen, .5, {css: {left: '-100%'}, delay:1.5})
   .to(creative.dom.productSection1, .5, {left: '0'});
   if(creative.dom.banner.offsetWidth != 160) {
     tl.to(creative.dom.footerImage, .5, {left  : '0'}, '-=.5');
   }
   if(creative.dom.banner.offsetWidth == 320) {
     tl.to(creative.dom.footerBestel, .5, {left: '190px'}, '-=.5');
   } else {
     tl.to(creative.dom.footerBestel, .5, {left: '0'}, '-=.5')
   }

   tl.to(creative.dom.productSection1, .5, {css: {left: '-100%'}, delay:3.5})
   ...
   .to(creative.dom.mainImgSectionEnd, .3, { css: { scale: 0.75 , y:-10 }, delay:0.2})
